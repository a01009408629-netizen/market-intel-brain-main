"""
MAIFA v3 Finnhub Normalizer
Normalizes validated Finnhub data to standard format
"""
...
class FinnhubNormalizer(DataNormalizer):
    """Finnhub data normalizer"""
    
    def __init__(self):
        self.logger = logging.getLogger("FinnhubNormalizer")
        
    async def normalize(self, validated_data: Dict[str, Any]) -> Dict[str, Any]:
        """Normalize validated Finnhub data to standard format"""
        try:
            ...
            for point in data_points:
                normalized_point = {
                    ...
                    "previous_close": point.get("previous_close"),
            ...
            if normalized_data["data"]:
                ...
                currents = [p.get("current") for p in normalized_data["data"] if isinstance(p.get("current"), (int, float))]
                ...
                if currents:
                    normalized_data["summary"]["current_price"] = currents[-1] if currents else None
